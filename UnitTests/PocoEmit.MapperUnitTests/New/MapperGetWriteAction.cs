...
public class MapperGetWriteAction : MapperMemberWriteTestBase
{
    [Fact]
    public void GetWriteAction_int()
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, int>(nameof(_instance.IntProperty));
        // Assert
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, int>(nameof(IntField));
        // Assert
        Assert.NotNull(writeAction);
        var source = IntField;
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, int?>(nameof(IntProperty));
        // Assert
        Assert.NotNull(writeAction);
        var source = IntProperty;
        writeAction(_instance, source);
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, decimal>(nameof(DecimalProperty));
        // Assert
        Assert.NotNull(writeAction);
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, decimal>(nameof(DecimalField));
        // Assert
        Assert.NotNull(writeAction);
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, string>(nameof(StringField));
        // Assert
        Assert.NotNull(writeAction);
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, string>(nameof(StringProperty));
        // Assert
        Assert.NotNull(writeAction);
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, DateTime>(nameof(TimeField));
        // Assert
        Assert.NotNull(writeAction);
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, DateTime>(nameof(TimeProperty));
        // Assert
        Assert.NotNull(writeAction);
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, object>(nameof(ObjectProperty));
        // Assert
        Assert.NotNull(writeAction);
    ...
    {
        // Act
        var writeAction = _mapper.GetWriteAction<TestInstance, object>(nameof(ObjectField));
        // Assert
        Assert.NotNull(writeAction);
