...
public class MapperGetReadFunc : MapperMemberTestBase
{
    [Fact]
    public void GetReadFunc_int()
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, int>(nameof(_instance.IntProperty));
        // Assert
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, int>(nameof(_instance.IntField));
        // Assert
        Assert.NotNull(readFunc);
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, decimal>(nameof(_instance.DecimalProperty));
        // Assert
        Assert.NotNull(readFunc);
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, decimal>(nameof(_instance.DecimalField));
        // Assert
        Assert.NotNull(readFunc);
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, string>(nameof(_instance.StringField));
        // Assert
        Assert.NotNull(readFunc);
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, string>(nameof(_instance.StringProperty));
        // Assert
        Assert.NotNull(readFunc);
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, DateTime>(nameof(_instance.TimeField));
        // Assert
        Assert.NotNull(readFunc);
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, DateTime>(nameof(_instance.TimeProperty));
        // Assert
        Assert.NotNull(readFunc);
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, object>(nameof(_instance.ObjectProperty));
        // Assert
        Assert.NotNull(readFunc);
    ...
    {
        // Act
        var readFunc = _mapper.GetReadFunc<TestInstance, object>(nameof(_instance.ObjectField));
        // Assert
        Assert.NotNull(readFunc);
