...
public class PocoReaderTests : PocoMemberTestBase
{
    [Fact]
    public void GetMemberReader_int()
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, int>(nameof(_instance.IntProperty));
        // Assert
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, int>(nameof(_instance.IntField));
        // Assert
        Assert.NotNull(reader);
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, decimal>(nameof(_instance.DecimalProperty));
        // Assert
        Assert.NotNull(reader);
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, decimal>(nameof(_instance.DecimalField));
        // Assert
        Assert.NotNull(reader);
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, string>(nameof(_instance.StringField));
        // Assert
        Assert.NotNull(reader);
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, string>(nameof(_instance.StringProperty));
        // Assert
        Assert.NotNull(reader);
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, DateTime>(nameof(_instance.TimeField));
        // Assert
        Assert.NotNull(reader);
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, DateTime>(nameof(_instance.TimeProperty));
        // Assert
        Assert.NotNull(reader);
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, object>(nameof(_instance.ObjectProperty));
        // Assert
        Assert.NotNull(reader);
    ...
    {
        // Act
        var reader = _poco.GetMemberReader<TestInstance, object>(nameof(_instance.ObjectField));
        // Assert
        Assert.NotNull(reader);
