...
public class PocoWriterTests : PocoMemberWriteTestBase
{
    [Fact]
    public void GetMemberWriter_int()
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, int>(nameof(_instance.IntProperty));
        // Assert
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, int>(nameof(IntField));
        // Assert
        Assert.NotNull(writer);
        var source = IntField;
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, int?>(nameof(IntProperty));
        // Assert
        Assert.NotNull(writer);
        var source = IntProperty;
        writer.Write(_instance, source);
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, decimal>(nameof(DecimalProperty));
        // Assert
        Assert.NotNull(writer);
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, decimal>(nameof(DecimalField));
        // Assert
        Assert.NotNull(writer);
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, string>(nameof(StringField));
        // Assert
        Assert.NotNull(writer);
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, string>(nameof(StringProperty));
        // Assert
        Assert.NotNull(writer);
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, DateTime>(nameof(TimeField));
        // Assert
        Assert.NotNull(writer);
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, DateTime>(nameof(TimeProperty));
        // Assert
        Assert.NotNull(writer);
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, object>(nameof(ObjectProperty));
        // Assert
        Assert.NotNull(writer);
    ...
    {
        // Act
        var writer = _poco.GetMemberWriter<TestInstance, object>(nameof(ObjectField));
        // Assert
        Assert.NotNull(writer);
