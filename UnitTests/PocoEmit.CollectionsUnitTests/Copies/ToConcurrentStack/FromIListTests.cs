...
namespace PocoEmit.CollectionsUnitTests.Copies.ToConcurrentStack;
...
public class FromIListTests : CollectionTestBase
{
    ...
    public void Copy_User2DTO()
    {
        ...
        ConcurrentStack<UserDTO> result = [];
    ...
    public void Copy_UserArray2DTO()
    {
        ...
        var result = new UserDTOConcurrentStack();
        _mapper.Copy(source, result);
    ...
    public void ConfigureMap()
    {
        ...
        ConcurrentStack<User> result = [];
        var copier = _mapper.GetCopier<IList<AutoUserDTO>, ConcurrentStack<User>>();
