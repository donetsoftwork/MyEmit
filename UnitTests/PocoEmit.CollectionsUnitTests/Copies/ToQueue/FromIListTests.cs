...
namespace PocoEmit.CollectionsUnitTests.Copies.ToQueue;
...
public class FromIListTests : CollectionTestBase
{
    ...
    public void ConfigureMap()
    {
        ...
        Queue<User> result = [];
        var copier = _mapper.GetCopier<IList<AutoUserDTO>, Queue<User>>();
