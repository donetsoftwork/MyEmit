...
namespace PocoEmit.CollectionsUnitTests.Copies.ToConcurrentQueue;
...
public class FromIListTests : CollectionTestBase
{
    ...
    public void Copy_User2DTO()
    {
        ...
        ConcurrentQueue<UserDTO> result = [];
    ...
    public void Copy_UserArray2DTO()
    {
        ...
        var result = new UserDTOConcurrentQueue();
        _mapper.Copy(source, result);
    ...
    public void ConfigureMap()
    {
        ...
        ConcurrentQueue<User> result = [];
        var copier = _mapper.GetCopier<IList<AutoUserDTO>, ConcurrentQueue<User>>();
