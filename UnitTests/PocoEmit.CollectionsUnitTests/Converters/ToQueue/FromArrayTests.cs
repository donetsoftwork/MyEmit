...
namespace PocoEmit.CollectionsUnitTests.Converters.ToQueue;
...
public class FromArrayTests : CollectionTestBase
{
    ...
    public void Convert_User2DTO()
    {
        ...
        var result = _mapper.Convert<User[], Queue<UserDTO>>(source);
    ...
    public void Convert_UserArray2DTO()
    {
        ...
        var result = _mapper.Convert<UserArray, UserDTOQueue>(source);
        Assert.NotNull(result);
    ...
    public void ConfigureMap()
    {
        ...
        var converter = _mapper.GetConverter<AutoUserDTO[], Queue<User>>();
