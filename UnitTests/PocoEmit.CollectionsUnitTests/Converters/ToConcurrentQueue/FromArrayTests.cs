...
namespace PocoEmit.CollectionsUnitTests.Converters.ToConcurrentQueue;
...
public class FromArrayTests : CollectionTestBase
{
    ...
    public void Convert_User2DTO()
    {
        ...
        var result = _mapper.Convert<User[], ConcurrentQueue<UserDTO>>(source);
    ...
    public void Convert_UserArray2DTO()
    {
        ...
        var result = _mapper.Convert<UserArray, UserDTOConcurrentQueue>(source);
        Assert.NotNull(result);
    ...
    public void ConfigureMap()
    {
        ...
        var converter = _mapper.GetConverter<AutoUserDTO[], ConcurrentQueue<User>>();
