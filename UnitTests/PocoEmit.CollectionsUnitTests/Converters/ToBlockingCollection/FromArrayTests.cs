...
namespace PocoEmit.CollectionsUnitTests.Converters.ToBlockingCollection;
...
public class FromArrayTests : CollectionTestBase
{
    ...
    public void Convert_User2DTO()
    {
        ...
        var result = _mapper.Convert<User[], BlockingCollection<UserDTO>>(source);
    ...
    public void Convert_UserArray2DTO()
    {
        ...
        var result = _mapper.Convert<UserArray, UserDTOBlockingCollection>(source);
        Assert.NotNull(result);
    ...
    public void ConfigureMap()
    {
        ...
        var converter = _mapper.GetConverter<AutoUserDTO[], BlockingCollection<User>>();
