...
public class FromListTests : CollectionTestBase
{
    ...
    public void Convert_ListUser2DTO()
    {
        ...
        var result = _mapper.Convert<List<User>, IDictionary<int, UserDTO>>(source);
    ...
    public void Convert_ListUserArray2DTO()
    {
        ...
        var result = _mapper.Convert<UserList, UserDTOIDictionary>(source);
        Assert.NotNull(result);
    ...
    public void ListConfigureMap()
    {
        ...
        var converter = _mapper.GetConverter<List<AutoUserDTO>, IDictionary<int, User>>();
