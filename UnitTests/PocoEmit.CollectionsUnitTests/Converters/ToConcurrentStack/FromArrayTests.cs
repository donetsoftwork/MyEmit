...
namespace PocoEmit.CollectionsUnitTests.Converters.ToConcurrentStack;
...
public class FromArrayTests : CollectionTestBase
{
    ...
    public void Convert_User2DTO()
    {
        ...
        var result = _mapper.Convert<User[], ConcurrentStack<UserDTO>>(source);
    ...
    public void Convert_UserArray2DTO()
    {
        ...
        var result = _mapper.Convert<UserArray, UserDTOConcurrentStack>(source);
        Assert.NotNull(result);
    ...
    public void ConfigureMap()
    {
        ...
        var converter = _mapper.GetConverter<AutoUserDTO[], ConcurrentStack<User>>();
