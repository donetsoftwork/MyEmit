...
namespace PocoEmit.CollectionsUnitTests.Converters.ToHashSet;
...
public class FromArrayTests : CollectionTestBase
{
    ...
    public void Convert_User2DTO()
    {
        ...
        var result = _mapper.Convert<User[], HashSet<UserDTO>>(source);
    ...
    public void Convert_UserArray2DTO()
    {
        ...
        var result = _mapper.Convert<UserArray, UserDTOHashSet>(source);
        Assert.NotNull(result);
    ...
    public void ConfigureMap()
    {
        ...
        var converter = _mapper.GetConverter<AutoUserDTO[], HashSet<User>>();
